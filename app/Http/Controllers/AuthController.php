...
class AuthController extends Controller
{
    ...
    public function postRegister(RegisterRequest $request)
    {
        ...
        //jika ingin otomatis redirect ke halaman dashboard/home
        // Auth::loginUsingId($user->id);
        // return redirect()->route('dashboard');

        return redirect()->back()->with('pesan', 'Registrasi berhasil, silahkan login dengan username dan password yang sudah anda daftarkan');
    }
